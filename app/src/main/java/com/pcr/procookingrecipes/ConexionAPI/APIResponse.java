...
public class APIResponse {
    private static final String API_KEY = "61adb1434eaa4266b233f21cc77d9931";  // Sustituye con tu clave de API de Spoonacular
    ...
    public List<Receta> searchAppleRecipes() {
        String urlString = BASE_URL + "?query=apple&number=10&addRecipeInformation=true&apiKey=" + API_KEY;
